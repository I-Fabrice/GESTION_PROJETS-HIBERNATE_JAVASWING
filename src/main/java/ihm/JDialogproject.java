...
public class JDialogproject extends JDialog{


    JDialog jDialogproject = new JDialog();
   ...
   public void clear(){
    ...
    public  JDialogproject(){

        jDialogproject.setSize(600,700);
        jDialogproject.setLocationRelativeTo(null);
        initComponents();
    }
    ...
    private void initComponents(){
       ...
       text3.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                label5.setText( text3.getText().length() + " /250" );
        ...
        //JDialog Profil
        jDialogproject.add(panel);
        jDialogproject.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        ...
        button1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    metierprojet.creationProjet(projet1,compte);
