...
public class JDialogequipe extends JDialog {

    JDialog jDialogequipe = new JDialog();
    ...
    public  JDialogequipe(JFrame frame){

        jDialogequipe.setSize(600,700);
        jDialogequipe.setLocationRelativeTo(null);
    ...
    private void initComponents(final JFrame frames){
        ...
        //JDialog Profil
        jDialogequipe.add(panel);
        jDialogequipe.setVisible(true);
