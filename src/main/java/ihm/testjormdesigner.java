...
public class testjormdesigner {
    ...
    private void label7MouseClicked(MouseEvent e) {
        ...
        try {
            ...
            List<Tache> data = metierTache.findtacheBycompte(p);
    ...
    private void label7MouseEntered(MouseEvent e) {
        // TODO add your code here
        label7.setBackground(new Color(60, 63, 65));
        label7.setForeground(Color.CYAN);
        //separator5.setForeground(Color.CYAN);
    }
    ...
    private void label5MouseClicked(MouseEvent e) {
        // TODO add your code here
        //JMenuItems
        JMenuItem menuItem30 = new JMenuItem("Team properties");
        JMenuItem menuItem31 = new JMenuItem("List of Member");
        JMenuItem menuItem32 = new JMenuItem("Statistique");
        ...
        try {
            equipe = equipeMetier.findequipebyname(name);
        ...
        menuItem32.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String name = (String) comboBox1.getSelectedItem();
                new statstage(name);
        ...
        //======== frame ========
        {
            ...
            //======== menuBar1 ========
            {
                ...
                //======== menu1 ========
                {
                    ...
                    {
                        menu5.setText("New");
                        menu5.setFont(new Font("Tahoma", Font.PLAIN, 15));

                        //---- menuItem1 ----
                        menuItem1.setText("Task            ");
                        menuItem1.setIcon(new ImageIcon("C:\\Users\\al-peco\\Downloads\\work_authorisation_24px.png"));
                        menuItem1.setFont(new Font("Tahoma", Font.PLAIN, 15));
                        ...
                        //---- menuItem2 ----
                        menuItem2.setText("Team");
                        menuItem2.setIcon(new ImageIcon("C:\\Users\\al-peco\\Downloads\\people_24px.png"));
                        menuItem2.setFont(new Font("Tahoma", Font.PLAIN, 15));
                        ...
                        //---- menuItem3 ----
                        menuItem3.setText("Budget");
                        menuItem3.setIcon(new ImageIcon("C:\\Users\\al-peco\\Downloads\\money_24px.png"));
                        menuItem3.setFont(new Font("Tahoma", Font.PLAIN, 15));
                    ...
                    //---- menuItem4 ----
                    menuItem4.setFont(new Font("Tahoma", Font.PLAIN, 15));
                    menuItem4.setText("New project                ");
            ...
            //======== splitPane1 ========
            {
                ...
                //======== panel1 ========
                {
                    ...
                    //---- label4 ----
                    label4.setText("  Delete team");
                    label4.setFont(new Font("Tahoma", Font.BOLD, 16));
                    label4.setIcon(new ImageIcon("C:\\Users\\al-peco\\Downloads\\delete_48488px.png"));
                    ...
                    panel1.add(label4);
                    label4.setBounds(90, 130, 145, label4.getPreferredSize().height);
                    ...
                    panel1.add(label5);
                    label5.setBounds(90, 165, 120, label5.getPreferredSize().height);
                    ...
                    panel1.add(label7);
                    label7.setBounds(195, 640, 105, 35);
    ...
    public void init(){
        ...
        label4.setBackground(new Color(60,63,65));
